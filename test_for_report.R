...
# index[,'f_birth']
#Count the number of the outlier whose value are negative
...
#Compare the result of carpet interpolation=================
set.seed(1001)
random_Number = sample(1:nrow(data),30)
data1 = data
data1[random_Number,17] = NA#17 is income
describe(data1)
...
#============construct train_data and test_data andtrain_data.abbr test_data.abbr==============
